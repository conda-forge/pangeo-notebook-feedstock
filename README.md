...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pangeo-notebook-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9188&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pangeo-notebook-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pangeo-notebook` can be installed with:

```
conda install pangeo-notebook
```

It is possible to list all of the versions of `pangeo-notebook` available on your platform with:
